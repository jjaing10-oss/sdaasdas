...
function parseKpiExcel(wb, filename){try{
  ...
  // ── 헬퍼: 본부행/지사행 판별 ──
  const isHqRow = function(r){ var n=hqName(r[1]); return n.length>=2 && n.indexOf('본부')>=0 && n.indexOf('본부')===n.length-2; };
  const isJisaRow = function(r,suffix){ var n=hqName(r[1]); return suffix?n.slice(-suffix.length)===suffix:(n.indexOf('소매')>=0||n.indexOf('도매')>=0); };
